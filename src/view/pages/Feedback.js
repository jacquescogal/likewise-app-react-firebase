...
const Feedback = ({setPageTitle}) => {
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <p class="mb-8 lg:mb-16 text-center text-gray-500 font-semibold sm:text-xl">Got a technical issue? Want to suggest a new activity? Have questions about our Business? Let us know.</p>
      <form action="#" class="space-y-8" onSubmit={e=>{e.preventDefault()}}>
        <div>
              <label for="subject" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tags:</label>
