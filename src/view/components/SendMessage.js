...
const SendMessage = ({scroll, messageScroll,chatRoom,currentUserName,currentImageUrl,toSend}) => {
  ...
  return (
    ...
    <form onSubmit={sendMessage} class=' w-full h-fit'>
        ...
        <textarea label="Message" value={value} onChange={(e)=>setValue(e.target.value)} id="chat" rows="1" class="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Your message..."></textarea>
